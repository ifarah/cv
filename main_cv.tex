...
\vspace{.15cm}
    ...
    \begin{tablist}
       % \item[2025] \quad{}Assistant Professor, Department of Urban and Regional Planning, University of Illinois at Urbana-Champaign (UIUC)\\ 
       \item[2024] \quad{} Illinois Distinguished Postdoctoral Research Associate, Department of \textbf{Urban and Regional Planning}, University of Illinois at Urbana-Champaign (UIUC) (Starting in August 2025)
       \end{tablist}
    ...
    \subitem \textbf{Urban Governance:} With a particular focus on intermediation and contestation, I examine how bureaucracies, nonprofits, and other intermediaries mediate governance, implement laws, and shape access to public services.
    \subitem \textbf{Spatial Dynamics:} Using computational and spatial techniques, I also examine informality and the ways people inhabit urban space, retail dynamics and its impact in the food system.
    \end{itemize}
