...
\vspace{.15cm}
    ...
    \subitem \textbf{Urban Governance:} With a particular focus on intermediation and contestation, I examine how \\
    \hspace{1.5em} 
    bureaucracies, nonprofits, and other intermediaries mediate governance, implement laws, and shape \\
    \hspace{1.5em} access to public services.
