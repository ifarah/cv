...
\usepackage{xcolor}
\usepackage[maxcitenames=20, minnames=3 ]{biblatex}
...
\vspace{.15cm}
\color{gray}
      %Dissertation: \textit{The Scramble for the City: Street Vending, Politics, and the Governance of Public Space in Mexico City and San Francisco} \\
      %Committee: Daniel Rodríguez (co‑chair), Alison Post (co‑chair), and Carolina Reid
\color{black}
      \item[M.A.] \tab{}\textbf{Social Sciences}, University of Chicago, Illinois, USA, 2016-2017 \\
\color{gray}
\vspace{.15cm}
      %Thesis: \textit{A Geospatial Analysis of Mexico’s Distal Effects on Food Insecurity} \\
      %Advisor: Luc Anselin
      \color{black}
      \item[B.A.] \tab{}\textbf{Political Science}, Instituto Tecnológico Autónomo de México (ITAM), Mexico City, Mexico, 2009-2013 \\
\color{gray}
\vspace{.15cm}
        %Thesis: \textit{Social Mobility of Women in Technical Schools in Mexico} \\
        %Advisor: Vidal Romero
    \end{tablist}

    \section*{Academic Appointments}
    \begin{tablist}
       %\item[2025] \quad{}Assistant Professor, Department of  \textbf{Urban and Regional Planning}, University of Illinois at Urbana-Champaign (UIUC).  \textit{Starting in August}\\ 
    ...
    \begin{itemize}
    \item My research focuses on \textbf{urban governance, informality,} and \textbf{spatial dynamics}.
    \subitem \textbf{Urban Governance:} With a particular focus on political intermediation and coordination between \\ 
    \hspace{1.5em} 
    multiple scales of government, I examine how bureaucracies, nonprofits, and other actors implement  \\
    \hspace{1.5em} laws, and shape access to public services.
    \subitem \textbf{Spatial Dynamics:} Using computational and spatial techniques, I also examine informality and the \\
    \hspace{1.5em} ways people inhabit urban space, retail dynamics and its impact in the food system.
    \end{itemize}
    
    \section*{Research Experience}
    \begin{tablist}
        \item[2019‐2020] \quad{}Graduate Researcher, \textbf{Institute of Urban and Regional Development}, UC Berkeley
        \item[2016‐2019] \quad{}Research Associate, \textbf{Center for Spatial Data Science}, University of Chicago
        \item[2014‐2015] \quad{}Research Advisor, \textbf{National Council for the Evaluation of Social Development Policy \\
    ...
    \begin{tablist}  
        \item[2025] \tab{}\fullcite{tianafood}
    ...
    %\subsection*{Under Revision and In Preparation}
    %\begin{tablist}  
    %    \item[2024] \tab{}\fullcite{kevinretail}
    %\end{tablist}
    ...
    \small{(*) = Invited} \\
    \begin{tablist}
        \item[2024] \tab{}\fullcite{apsaluskin2024}
        \item[2024] \tab{}\fullcite{acsp2024}
        \item[2024] \tab{}\fullcite{lasa2024}
...
American Association of Geographers (AAG) 
    ...
    \section*{Skills}
\textbf{Statistical Analysis and Computation:} Python, R, STATA, PostgreSQL, Google Cloud Console  

\textbf{Spatial Analysis and GIS:} GeoDa, QGIS, ArcGIS, PostGIS, Google Earth Engine  

\textbf{General Tools:} MS Office, LaTeX, Git  

\textbf{Languages:} Spanish, English, German (A2), French (A1)


    \section*{References}

\textbf{Andrew Greenlee}. Professor of Urban and Regional Planning at University of Illinois, Urbana-Champaign (agreen4@illinois.edu).  

\vspace{1em}  
    
\textbf{Alison Post}. Professor of Political Science at University of California, Berkeley (aepost@berkeley.edu).  


\vspace{1em}  
\textbf{Daniel Rodriguez}. Professor of City and Regional Planning at University of California, Berkeley (danrod@berkeley.edu)  

\vspace{1em}  
    
\textbf{Carolina Reid}. Professor of City and Regional Planning at University of California, Berkeley (c\_reid@berkeley.edu)  

\vspace{1em}  
    
\textbf{Luc Anselin}. Professor of Sociology and Director of Center for Spatial Data Science at University of Chicago (anselin@uchicago.edu)
